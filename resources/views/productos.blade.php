...
<style>
    ...
    /* Modal de éxito - estilos personalizados */
...
<div class="collapse mb-5 {{ $errors->any() ? 'show' : '' }}" id="formularioPersonalizado">
    <div class="card form-card shadow-sm">
        <div class="card-body p-4">
            {{-- ⚠️ BLOQUE TEMPORAL DE DIAGNÓSTICO --}}
            @if ($errors->any())
...
<div class="modal fade modal-exito" id="modalExito" tabindex="-1" aria-labelledby="modalExitoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h5 class="mb-3">¡Gracias por tu solicitud!</h5>
                <p class="text-muted mb-0">
                    {{ session('success') ?? 'Tu solicitud fue enviada correctamente. Te contactaremos pronto.' }}
                </p>
            </div>
...
{{-- Script que abre el modal automáticamente cuando hay session('success') --}}
@if (session('success'))
<script>
